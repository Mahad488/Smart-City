...
const Emergency: React.FC = () => {
  ...
  const fetchEmergencies = async () => {
    try {
      ...
      const response = await fetch(
        "https://smart-city-backend-16ly-qaxrjy16l-m-92de.vercel.app/api/emergencies/"
      );
  ...
  const handleEditEmergency = async () => {
    ...
    try {
      const response = await fetch(
        `https://smart-city-backend-16ly-qaxrjy16l-m-92de.vercel.app/api/emergencies/${editingEmergency.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDeleteEmergency = async (id: number) => {
    try {
      const response = await fetch(
        `https://smart-city-backend-16ly-qaxrjy16l-m-92de.vercel.app/api/emergencies/${id}`,
        {
          method: "DELETE",
        }
      );
